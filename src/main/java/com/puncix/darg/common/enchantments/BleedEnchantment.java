...
public class BleedEnchantment extends Enchantment {
    public BleedEnchantment(Rarity rarityIn, EnchantmentType typeIn, EquipmentSlotType[] slots) {
    ...
    public void onEntityDamaged(LivingEntity user, Entity target, int level) {
        if( target.isAlive()){
            ...
            entity.addPotionEffect( new EffectInstance(EffectInit.BLEED.get(), 100 , 3, true, true));
