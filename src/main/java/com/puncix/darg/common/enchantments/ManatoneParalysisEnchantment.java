...
public class ManatoneParalysisEnchantment extends Enchantment {
    public ManatoneParalysisEnchantment(Rarity rarityIn, EnchantmentType typeIn, EquipmentSlotType[] slots) {
    ...
    public void onEntityDamaged(LivingEntity user, Entity target, int level) {
        if( target.isAlive()){
            ...
            entity.addPotionEffect( new EffectInstance(EffectInit.MANATONE_PARALYSIS.get(), 100 , 3, true, true));
