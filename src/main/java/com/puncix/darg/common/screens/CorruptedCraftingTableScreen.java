...
public class CorruptedCraftingTableScreen extends ContainerScreen<CorruptedCraftingTableContainer>{
	
	private final ResourceLocation GUI = new ResourceLocation(Darg.MOD_ID, "textures/gui/corrupted_crafting_table_gui.png");
	public CorruptedCraftingTableScreen(CorruptedCraftingTableContainer p_i51105_1_, PlayerInventory p_i51105_2_,
