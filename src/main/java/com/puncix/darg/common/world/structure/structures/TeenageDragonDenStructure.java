...
public class TeenageDragonDenStructure extends Structure<NoFeatureConfig> {


    public TeenageDragonDenStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return TeenageDragonDenStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(Darg.MOD_ID, "teenage_dragon_den/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Teenage Dragon Den at " +
