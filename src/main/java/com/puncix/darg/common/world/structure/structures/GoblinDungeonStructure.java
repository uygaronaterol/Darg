...
public class GoblinDungeonStructure extends Structure<NoFeatureConfig> {


    public GoblinDungeonStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return GoblinDungeonStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(Darg.MOD_ID, "goblin_dungeon/start_pool")),
                            8), AbstractVillagePiece::new, chunkGenerator, templateManagerIn,
                    blockpos, this.components, this.rand,false,true);

            this.components.forEach(piece -> piece.offset(0, -16, 0));
            this.components.forEach(piece -> piece.getBoundingBox().minY -= 0);

            this.recalculateStructureSize();

            LogManager.getLogger().log(Level.DEBUG, "Goblin Dungeon at " +
