...
public class CraftingHand extends HorizontalBlock {
    public CraftingHand(Properties properties) {
        super(properties);
    }
    ...
    public ActionResultType onBlockActivated(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_,
        ...
        if(!p_225533_2_.isRemote()) {
            ...
            if(tileEntity instanceof CraftingHandTile) {
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.darg.crafting_hand");
            }

            @Nullable
            @Override
            public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity) {
                return new CraftingHandContainer(i, worldIn, pos, playerInventory, playerEntity);
            }
        };
    }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        // TODO Auto-generated method stub
        return ModTileEntities.CRAFTING_HAND_TILE.get().create();
    }
