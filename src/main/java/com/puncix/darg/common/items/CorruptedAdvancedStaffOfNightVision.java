...
public class CorruptedAdvancedStaffOfNightVision extends Item {


    public CorruptedAdvancedStaffOfNightVision(Properties properties) {
        super(properties);
    }
    ...
    public void inventoryTick(ItemStack p_77663_1_, World p_77663_2_, Entity p_77663_3_, int p_77663_4_,
        ...
        if( p_77663_3_.isAlive()){
            ...
            entity.addPotionEffect( new EffectInstance(Effects.NIGHT_VISION, 100));
        }
