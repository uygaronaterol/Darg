...
public class DoranzerShield extends ShieldItem {
    public DoranzerShield(Item.Properties builder) {
        super(builder);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        playerIn.addPotionEffect( new EffectInstance(Effects.REGENERATION, 300));
