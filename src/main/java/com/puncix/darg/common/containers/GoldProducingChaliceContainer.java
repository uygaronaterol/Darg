...
public class GoldProducingChaliceContainer extends Container{
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public GoldProducingChaliceContainer(int windowid, World world, BlockPos blockpos,
                                           PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.GOLD_PRODUCING_CHALICE_CONTAINER.get(), windowid);
    ...
    public boolean canInteractWith(PlayerEntity playerEntity) {
        ...
        return isWithinUsableDistance( IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity,
                BlockInit.GOLD_PRODUCING_CHALICE.get());
    }
