...
@OnlyIn(Dist.CLIENT)
public class BlackParticle extends SpriteTexturedParticle {

    protected BlackParticle(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ) {
