...
public class KatsuEntity extends CreatureEntity {
    public KatsuEntity(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public void attackEntityWithRangedAttack(LivingEntity target) {
        ...
        soepe.setItem(ItemInit.SHURIKEN.get().getDefaultInstance());
