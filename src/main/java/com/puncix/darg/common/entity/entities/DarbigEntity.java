...
public class DarbigEntity extends CreatureEntity {
    public DarbigEntity(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public ActionResultType getEntityInteractionResult(PlayerEntity player, Hand hand) {
        ...
        if (itemstack.getItem() == Items.LEAD && this.canBeLeashedTo(player)) {
            ...
            if (itemstack.getItem() instanceof SpawnEggItem) {
            ...
            } else if(itemstack.getItem() == ItemInit.NUTRITIOUS_MOGLING_FOOD.get()) {
                ...
                if(rand <= 0.3) {
                    ...
                    this.entityDropItem(Items.ENCHANTED_GOLDEN_APPLE.asItem());
                }
