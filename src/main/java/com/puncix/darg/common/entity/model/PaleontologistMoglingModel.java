...
public class PaleontologistMoglingModel  <T extends PaleontologistMoglingEntity> extends EntityModel<T>  {
    ...
    public PaleontologistMoglingModel() {
        textureWidth = 32;
        textureHeight = 32;
        ...
        rightEar.setTextureOffset(6, 9).addBox(-1.0F, -2.0F, 4.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
        rightEar.setTextureOffset(6, 20).addBox(-1.0F, -2.0F, 2.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        leftEar.setTextureOffset(16, 19).addBox(-1.0F, -2.0F, -5.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        leftEar.setTextureOffset(6, 7).addBox(-1.0F, -2.0F, -6.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);

        hat = new ModelRenderer(this);
        hat.setRotationPoint(-1.0F, 7.0F, 0.0F);
        head.addChild(hat);
        hat.setTextureOffset(10, 0).addBox(-3.0F, -11.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
        hat.setTextureOffset(18, 15).addBox(-1.0F, -12.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);

        leftLeg = new ModelRenderer(this);
        leftLeg.setRotationPoint(1.0F, -3.0F, -1.0F);
        body.addChild(leftLeg);
        leftLeg.setTextureOffset(20, 6).addBox(-2.0F, 2.0F, -1.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
        leftLeg.setTextureOffset(10, 12).addBox(-1.0F, 1.0F, -1.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);

        rightLeg = new ModelRenderer(this);
        rightLeg.setRotationPoint(1.0F, -2.0F, 1.0F);
        body.addChild(rightLeg);
        rightLeg.setTextureOffset(20, 8).addBox(-2.0F, 1.0F, 0.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
        rightLeg.setTextureOffset(10, 10).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);

        tail = new ModelRenderer(this);
        tail.setRotationPoint(6.5F, -3.5F, 0.0F);
        body.addChild(tail);
        tail.setTextureOffset(8, 17).addBox(-4.5F, -0.5F, -1.0F, 3.0F, 1.0F, 2.0F, 0.0F, false);

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
        tail.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, -0.48F, 0.0F);
        cube_r1.setTextureOffset(16, 10).addBox(-2.5F, -0.5F, 0.0F, 3.0F, 1.0F, 2.0F, 0.0F, false);
    }
