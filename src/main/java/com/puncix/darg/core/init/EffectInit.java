...
import com.puncix.darg.common.effects.DjinniEffect;
import com.puncix.darg.common.effects.ManatoneParalysisEffect;
import com.puncix.darg.common.effects.TimeFreezeEffect;
...
public class EffectInit {
    ...
    public static final RegistryObject<Effect> BLEED = MOD_EFFECTS.register("bleed",
            () -> new BleedEffect(EffectType.HARMFUL, 0x800000));
    ...
    public static final RegistryObject<Effect> DJINNI = MOD_EFFECTS.register("djinni",
            () -> new DjinniEffect(EffectType.HARMFUL, 0x4f7942));
    public static final RegistryObject<Effect> TIME_FREEZE = MOD_EFFECTS.register("time_freeze",
            () -> new TimeFreezeEffect(EffectType.HARMFUL, 0xccffff).addAttributesModifier(Attributes.MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", (double)-1F, AttributeModifier.Operation.MULTIPLY_TOTAL));
